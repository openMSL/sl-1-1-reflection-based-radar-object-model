...
void model::Segmentation::apply(SensorData& sensor_data)
{
    ...
    int no_of_moving_objects = sensor_data.sensor_view(0).global_ground_truth().moving_object_size();
    ...
    if (sensor_data.has_logical_detection_data())
    {
        ...
        for (int object_no_in = 0; object_no_in < no_of_moving_objects; object_no_in++)
        {
            ...
            {  // Continue sensor_data case of ego car
...
int Segmentation::calculate_segment_of_point_cloud(SensorData& sensor_data,
                                                   int object_no_in,
                                                   ...
                                                   const Log& log)
{
    ...
    int segment_size_of_current_object = 0;
