...
namespace model {
    ...
    public:
        ...
        static Vector3d transform_position_from_object_to_sensor_coordinates(const Vector3d &pcl_segment_position_in_object, const TransformationFunctions::EgoData &ego_data, const MountingPosition &mounting_pose, const BaseMoving &object_base);
